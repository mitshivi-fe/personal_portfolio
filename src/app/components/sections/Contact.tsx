...
export default function Contact() {
  return (
    <section id="contact" className="py-16 lg:py-20 bg-zinc-50 dark:bg-zinc-950">
      <Container>
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-zinc-900 dark:text-zinc-100 mb-4 tracking-tight">
            Let&apos;s Work Together
          </h2>
